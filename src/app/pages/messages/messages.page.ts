...
export class MessagesPage implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.websocketService.messageReceived.subscribe((message: string) => {
      let streamedMessage = JSON.parse(message);
      console.log('Message received:', streamedMessage.data.text);
      console.log('type of:', typeof streamedMessage.data.text);

      this.receivedMessages.push(streamedMessage.data.text);
    });
  }
